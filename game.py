...
def menu():
    while True:
        ...
        try:
            ...
            print("1. Hunt")
            print("2. Train")
            print("3. Save") # need to add a loader
            print("4. Exit")
            ...
            if choice == 1:
                ...
                if functions.saveGameMetaData["epochTime"] + 300 < int(time.time()) and functions.saveGameMetaData["epochTime"]:
                    um = input("It has been 5 minutes since you last saved. Press 1 to save your game or press any other key to exit: ")
                    if um == "1":
                        functions.saver()
...
def hunt():
    ...
    while True:
        ...
        if response == "yes":
            ...
            input("You walk back to your home, tired from the hunt. Enter any key to continue...\n")
            break